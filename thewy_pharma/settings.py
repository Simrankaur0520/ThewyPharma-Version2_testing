"""
Django settings for thewy_pharma project.
...
ROOT_URLCONF = 'thewy_pharma.urls'
...
# -------------------------------- rest api ---------------------------------------------------------
ALLOWED_HOSTS = ALLOWED_HOSTS + ['*'] + ['simrankaur0520.pythonanywhere.com', 'localhost', '104.197.132.196']
